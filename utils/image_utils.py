...
from app import db, UPLOAD_FOLDER, ALLOWED_EXTENSIONS

def download_image_from_url(url: str, upload_folder: str, product_code: str = None) -> str | None:
...
def vincular_imagens_por_codigo(app):
    ...
    with app.app_context():
        ...
        for filename in os.listdir(UPLOAD_FOLDER):
            ...
            if ext.lower().strip('.') not in ALLOWED_EXTENSIONS: continue
