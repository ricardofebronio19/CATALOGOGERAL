...
# Script para preparar release v2.1.4
...
- Melhorias visuais na tabela de produtos similares
- Filtro de similares refinado com melhor correspondência por veículo
...
if ($CreateRelease) {
    ...
    try {
        ...
        $updateConfig = @{
            ...
            release_notes = "v$Version — Melhorias visuais e filtro de similares`n`n✨ NOVIDADES:`n- Melhor divisão visual da tabela de aplicações e da tabela de produtos similares`n- Filtro de similares refinado com preservação das colunas originais e melhor correspondência por veículo"
            size_mb = "37"
