...
def organizar_csv(arquivo_entrada: str, arquivo_saida: str, default_montadora: str = ""):
    """
        ...
        with open(
            ...
            for i, linha_bruta in enumerate(f_entrada, 2):
                ...
                for app_str in aplicacoes_brutas.split("|"):
                    ...
                    veiculo, ano = extrair_ano(app_str) # type: ignore
...
if __name__ == "__main__":
    organizar_csv("export_pecas.csv", "pecas_para_importar.csv", default_montadora="FIAT")
