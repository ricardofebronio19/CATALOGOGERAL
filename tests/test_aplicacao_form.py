    ...
    try:
        ...
        try:
            with app.app_context():
                ...
                # Login
                resp = client.post('/login', data={'username': 'testadmin', 'password': 'pass'}, follow_redirects=True)
                ...
                resp = client.post('/admin/peca/adicionar', data=form, follow_redirects=True)
                assert resp.status_code == 200
