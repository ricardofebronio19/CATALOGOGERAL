...
similares_association = db.Table(
    "similares_association",
...
class Produto(db.Model):
    ...
    similares = db.relationship(
        "Produto",
        secondary=similares_association,
    ...
    aplicacoes = db.relationship(
        "Aplicacao", backref="produto", lazy=True, cascade="all, delete-orphan"
    )
