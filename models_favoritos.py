...
class ItemListaFavoritos(db.Model):
    ...
    produto = db.relationship('Produto', backref=db.backref('favoritos', cascade='all, delete-orphan'))
...
class HistoricoVisualizacao(db.Model):
    ...
    produto = db.relationship('Produto', backref=db.backref('visualizacoes', cascade='all, delete-orphan'))
...
class ProdutoRecomendado(db.Model):
    ...
    produto = db.relationship('Produto', backref=db.backref('recomendacoes', cascade='all, delete-orphan'))
...
class CompartilhamentoLista(db.Model):
    ...
    lista = db.relationship('ListaFavoritos', backref=db.backref('compartilhamentos', cascade='all, delete-orphan'))
