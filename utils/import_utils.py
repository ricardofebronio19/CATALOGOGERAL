...
def _parse_e_salvar_aplicacoes(produto_alvo: Produto, nome_produto: str, texto_aplicacoes: str, montadora_geral: str = None, grupo: str = None, fornecedor: str = None, conversoes: str = None, observacoes: str = None):
    ...
    for aplicacao_str in texto_aplicacoes.split('|'):
        ...
        for veiculo_nome in veiculos_potenciais:
            ...
            nova_aplicacao = Aplicacao(veiculo=veiculo_nome, ano=ano_str.strip(), montadora=montadora, produto=produto_alvo)
        ...
        try:
            with open(filepath, 'r', encoding='utf-8-sig', errors='ignore') as f:
                ...
                for row in reader:
                    ...
                    if texto_ano: texto_aplicacoes = f"{texto_aplicacoes} {texto_ano}"
                    ...
                    _parse_e_salvar_aplicacoes(produto_alvo, nome_produto, texto_aplicacoes, montadora_geral, grupo, fornecedor, conversoes, observacoes)

                db.session.commit()
                print(f'Importação concluída! {produtos_adicionados} produtos adicionados, {produtos_atualizados} atualizados.')
